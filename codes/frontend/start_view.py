...
# Append the root directory to sys.path to access version information
...
class StartWindow(QMainWindow):
    def __init__(self):
        ...
        # Set up the scrollable area before adjusting layout
    ...
    def adjust_scroll_area(self):
        ...
        scroll_y = search_y + search_height + 20
